...
const translations = {
  zh: {
    ...
    "courses.activity4": "这类内容后续适合做成后台独立栏目，方便学校按学期更新",
    "news.eyebrow": "学校新闻",
    ...
    "students.footerNote": "学生作品与活动成果预览",
    "students.footerSub": "持续整理原站内容",
    ...
    "hsk.use2Text": "原站明确提到孔子学院奖学金等中国大学奖学金通常需要 HSK3 级以上证书。",
    "hsk.use3Title": "求职就职",
    ...
    "hsk.related1Text": "考试时间、级别安排与报名入口均已在原站发布，适合后续做成后台独立维护的考试通知卡片。",
    ...
    "hsk.related3Text": "原站已保留英文稿件，后续新版可继续支持中英双语考试信息发布。",
    "hsk.footerLabel": "HSK Test Center",
    "contact.eyebrow": "招生联系",
    "contact.heroTitle": "报名、课程咨询与考试联系入口",
    "contact.heroText": "这一页先把家长最常用的信息集中起来，后续正式后台可独立维护招生简章、学期安排、新生班信息、报名表单和考试通知。",
    ...
    "contact.introBody": `<p>近一年原站已发布春季、秋季课程安排、夏令营、基础班招生与文化班招生等内容。新版站点后续可以把这些信息拆成更清晰的栏目，比如「新生报名」「学期安排」「文化班招生」和「活动报名」。</p><p>当前预览阶段先保留真实联系信息和原站通知入口，确保家长能看懂、能联系、能继续报名。</p>`,
    ...
    "contact.link2Text": "适合放进后续独立活动报名栏目，目前先保留原文入口。",
    "contact.link3Title": "2026 春季安排",
    "contact.link3Text": "原站保留了春季课程与报名邮箱信息，可作为学期通知归档参考。",
    "contact.backendEyebrow": "后台方向",
    "contact.backendTitle": "后续客户后台最适合先做这几类内容管理。",
    "contact.backend1": "新闻动态：活动报道、课程通知、学期安排",
    "contact.backend2": "招生简章：新生班、文化班、夏令营等报名说明",
    "contact.backend3": "固定页面：学校简介、课程体系、HSK 信息、联系方式",
    "contact.backend4": "媒体内容：封面图、活动海报、教师或班级说明图"
  },
  en: {
    ...
    "courses.activity4": "These items are strong candidates for separate CMS categories later, updated term by term",
    ...
    "news.footerNote": "News archive preview from the past year",
    ...
    "students.footerNote": "Preview of student work and activity highlights",
    "students.footerSub": "Original site content is being reorganized",
    "hsk.eyebrow": "HSK / Test Center",
    ...
    "hsk.use2Text": "The original site notes that scholarships from Chinese universities often require HSK level 3 or above.",
    ...
    "hsk.related1Text": "Exam dates, level arrangements and registration links have already been published and fit well as CMS-managed notice cards later.",
    ...
    "hsk.related3Title": "Stockholm Center Completed Successfully",
    "hsk.related3Text": "The original site already preserved an English draft, which can support multilingual HSK publishing in the new site as well.",
    "hsk.footerLabel": "HSK Test Center",
    "contact.eyebrow": "Admissions",
    "contact.heroTitle": "Registration, course inquiries and exam contact",
    "contact.heroText": "This page gathers the most frequently used information for families. Later, the final CMS can manage admissions notices, term updates, new student classes, forms and exam announcements.",
    ...
    "contact.introBody": `<p>Over the past year, the original site has published spring and autumn course plans, summer camp announcements, beginner admissions and cultural class recruitment. In the new site, these can later be separated into clearer categories such as new student enrollment, term schedule, cultural classes and activity registration.</p><p>At the current preview stage, the site keeps the real contact information and practical notice entry points so families can still understand, contact and register.</p>`,
    ...
    "contact.link2Text": "A good candidate for a standalone future activity-registration category, while the preview keeps the content accessible now.",
    "contact.link3Title": "2026 Spring Term Information",
    "contact.link3Text": "The original site preserved spring course details and admissions email information as useful archive material.",
    "contact.backendEyebrow": "CMS Direction",
    "contact.backendTitle": "These are the content areas most suitable for staff to manage first in the future backend.",
    "contact.backend1": "News and updates: event reports, course notices and term schedules",
    "contact.backend2": "Admissions guides: new students, cultural classes, summer camp and other enrollment notes",
    "contact.backend3": "Fixed pages: school profile, course structure, HSK information and contact details",
    "contact.backend4": "Media assets: cover images, event posters and teacher or class illustrations"
  },
  sv: {
    ...
    "courses.activity4": "Det här passar väl som separata CMS-kategorier längre fram, uppdaterade termin för termin",
    ...
    "news.footerNote": "Förhandsvisning av nyhetsarkiv från det senaste året",
    ...
    "students.footerNote": "Förhandsvisning av elevverk och aktivitetsresultat",
    "students.footerSub": "Innehåll från den gamla webbplatsen omarbetas löpande",
    ...
    "hsk.use2Text": "Den ursprungliga webbplatsen nämner att stipendier från kinesiska universitet ofta kräver HSK nivå 3 eller högre.",
    ...
    "hsk.related1Text": "Provdatum, nivåer och anmälningslänkar är redan publicerade och lämpar sig väl som CMS-hanterade notiskort senare.",
    ...
    "hsk.related3Title": "Stockholm Center Completed Successfully",
    "hsk.related3Text": "Den gamla webbplatsen bevarade redan en engelsk version, vilket kan stödja fortsatt flerspråkig publicering av HSK-information.",
    "hsk.footerLabel": "HSK Testcenter",
    "contact.eyebrow": "Antagning",
    "contact.heroTitle": "Anmälan, kursfrågor och kontakt för prov",
    "contact.heroText": "Den här sidan samlar den information som familjer oftast behöver. Senare kan det slutliga CMS-systemet hantera antagningsnotiser, terminsplaner, nya elevklasser, formulär och provmeddelanden.",
    ...
    "contact.introBody": `<p>Under det senaste året har den gamla webbplatsen publicerat planer för vår och höst, sommarläger, nybörjarantagning och kulturklasser. I den nya webbplatsen kan detta senare delas upp i tydligare kategorier som ny elevantagning, terminsplan, kulturklasser och aktivitetsanmälan.</p><p>I den aktuella förhandsversionen behålls de verkliga kontaktuppgifterna och praktiska informationsingångarna så att familjer fortfarande kan förstå, kontakta och anmäla sig.</p>`,
    ...
    "contact.link2Text": "Ett bra ämne för en egen framtida kategori för aktivitetsanmälan, medan förhandsversionen håller innehållet tillgängligt redan nu.",
    "contact.link3Title": "Information om vårterminen 2026",
    "contact.link3Text": "Den gamla webbplatsen sparade uppgifter om vårterminens kurser och antagningsmejl som användbart arkivmaterial.",
    "contact.backendEyebrow": "CMS-riktning",
    "contact.backendTitle": "Det här är de innehållsområden som personalen bör kunna hantera först i det framtida systemet.",
    "contact.backend1": "Nyheter och uppdateringar: aktivitetsrapporter, kursmeddelanden och terminsplaner",
    "contact.backend2": "Antagningsguider: nya elever, kulturklasser, sommarläger och annan anmälningsinformation",
    "contact.backend3": "Fasta sidor: skolpresentation, kursstruktur, HSK-information och kontaktuppgifter",
    "contact.backend4": "Medieresurser: omslagsbilder, aktivitetsaffischer och illustrationer för lärare eller klasser"
  }
};
